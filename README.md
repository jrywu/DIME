...
1. 下載安裝檔
   ...
   **最新穩定發行版本 DIME v.1.3.644（更新日期: 2026-05-08）**
   ...
   <!-- DOWNLOAD_START -->     
     <details>
     <summary><b>最新開發版本 DIME v1.3.655 (更新日期: 2026-05-18)</b></summary>
   <!-- DOWNLOAD_END -->
...
3. **（建議）驗證檔案完整性：**
   ...
   **最新穩定發行版本 DIME v.1.3.644 SHA-256 CHECKSUM (更新日期: 2026-05-08):**
   <!-- RELEASE_CHECKSUM_START -->    
    | 檔案 | SHA-256 CHECKSUM |
    |------|----------------|
    | DIME-Universal.exe | `CD82EC8A81B9A1E722DB8F4A64596A1E913BD20906A75B33A6A3B1D0C301271B` |
    | DIME-Universal.zip | `AF914F8CA9ED02BB2D4C1888E77FA46596DE43763AA7590B4066251518AC2317` |
    | DIME-64bit.msi | `4DA9D8FC52A782328D34DD6EA9AADFEC477AC72F2314C5E24CB62E07A0E9DFDA` |
    | DIME-32bit.msi | `95E27015FAC5557869857CD80BC930BA41B8D14BE031A9730BBD1D1055F99E37` |
   <!-- RELEASE_CHECKSUM_END -->   

   <!-- CHECKSUM_START -->
     <details>     
     <summary><b>最新開發版本 DIME v1.3.655 SHA-256 CHECKSUM (更新日期: 2026-05-18)</b></summary>
   
    | 檔案 | SHA-256 CHECKSUM |
    |------|----------------|
    | DIME-Universal.exe | `0F226D9316876BBA16D3748A4B0061D003306AF1765F86DF8D57155414D805B6` |
    | DIME-Universal.zip | `6BEEA5F0826F1AB4FA174AFD7E11012A42537F265846CDD1D731D9FFACA5ECF9` |
    | DIME-64bit.msi | `D6E5D94A6E9273802217404FBB47587F9CFACD1FC9E5C6ED83AF3D8E9A1DB8C3` |
    | DIME-32bit.msi | `E4A069D6AE228CEE91A1DF9B15C8F14207A947125D6BB77C905364EC208CD745` |
   <!-- CHECKSUM_END -->
     </details>
...
| ------ | ------------- | ------------- | ------ |
| CapsLock 關輸出符號 | Shift 字元（`!`） | 基礎數字（`1`） | **預設行為** |
| CapsLock 關輸出數字 | 基礎數字（`1`） | Shift 字元（`!`） | |
...
| Shift英數模式數字鍵行為 | 設定在 Shift 英數輸入模式下，數字鍵的輸出行為（`CapsLock 關輸出符號`、`CapsLock 關輸出數字`、`永遠輸出符號`） |
| 組字區最大長度 | 設定輸入碼的最大字元數 |
...
| `Array-Ext-EF.cin` | CJK Ext-E~J 擴充字 |
| `Array-Phrase.cin` | 行列詞庫 |
