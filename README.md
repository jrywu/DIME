...
1. 下載安裝檔
   ...
   **最新穩定發行版本 DIME v.1.3.644（更新日期: 2026-05-08）**
   ...
   <!-- DOWNLOAD_START -->     
     <details>
     <summary><b>最新開發版本 DIME v1.3.663 (更新日期: 2026-07-06)</b></summary>
   <!-- DOWNLOAD_END -->
...
3. **（建議）驗證檔案完整性：**
   ...
   **最新穩定發行版本 DIME v.1.3.644 SHA-256 CHECKSUM (更新日期: 2026-05-08):**
   ...
   <!-- CHECKSUM_START -->
     <details>     
     <summary><b>最新開發版本 DIME v1.3.663 SHA-256 CHECKSUM (更新日期: 2026-07-06)</b></summary>
   
    | 檔案 | SHA-256 CHECKSUM |
    |------|----------------|
    | DIME-Universal.exe | `8DA26A273B28AB05A46D623582B2A9E934F5C0FC2D95A4C50DDB319E6EBD8C65` |
    | DIME-Universal.zip | `CE23CEB1BA6B751306C57AC7CA46D34698EF605C03E81915B1E79B63AE00AC89` |
    | DIME-64bit.msi | `CFC4625F3F727660DA0B30FEC583C8C9DFEC1761273FD2A65A8DB753A5C7FB88` |
    | DIME-32bit.msi | `981E19F3A809A06A5D842A5848AD2BE7A90D769D841524D6DAB9C198B0D28AFA` |
   <!-- CHECKSUM_END -->
     </details>
