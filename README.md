...
1. 下載安裝檔
   ...
   **最新穩定發行版本 DIME v.1.3.557（更新日期: 2026-03-29）**
   ...
   <!-- DOWNLOAD_START -->     
     <details>
     <summary><b>最新開發版本 DIME v1.3.561 (更新日期: 2026-03-30)</b></summary>
   <!-- DOWNLOAD_END -->
...
3. **（建議）驗證檔案完整性：**
   ...
   **最新穩定發行版本 DIME v.1.3.557 SHA-256 CHECKSUM (更新日期: 2026-03-29):**
   ...
   <!-- CHECKSUM_START -->
     <details>     
     <summary><b>最新開發版本 DIME v1.3.561 SHA-256 CHECKSUM (更新日期: 2026-03-30)</b></summary>
   
    | 檔案 | SHA-256 CHECKSUM |
    |------|----------------|
    | DIME-Universal.exe | `8D1E6921186B526312068B7B76A6CB9A4D1DB99E00B9823439A6A5E0124725D0` |
    | DIME-Universal.zip | `C3267F0D30C8E4E8DE8F9FB3D516A636400D30B639F0BD98A8BD14475C94EC54` |
    | DIME-64bit.msi | `2A46E73FE9370C1831EA809795C34BC6F6D9EB7F4025FB5153993539C2026B19` |
    | DIME-32bit.msi | `C6BEE63B25D11C5B21860EAAF71BE40575C4768D1DCD8B9B2A5FCCF59E073E2F` |
   <!-- CHECKSUM_END -->
     </details>
