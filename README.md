...
1. 下載安裝檔
   ...
   **最新穩定發行版本 DIME v.1.3.557（更新日期: 2026-03-29）**
   ...
   <!-- DOWNLOAD_START -->     
     <details>
     <summary><b>最新開發版本 DIME v1.3.574 (更新日期: 2026-03-30)</b></summary>
   <!-- DOWNLOAD_END -->
...
3. **（建議）驗證檔案完整性：**
   ...
   **最新穩定發行版本 DIME v.1.3.557 SHA-256 CHECKSUM (更新日期: 2026-03-29):**
   ...
   <!-- CHECKSUM_START -->
     <details>     
     <summary><b>最新開發版本 DIME v1.3.574 SHA-256 CHECKSUM (更新日期: 2026-03-30)</b></summary>
   
    | 檔案 | SHA-256 CHECKSUM |
    |------|----------------|
    | DIME-Universal.exe | `68F17A654F7A3C7222A1FB592C7CA31C28835AC466D4D538BE70A43C6ADE0E36` |
    | DIME-Universal.zip | `378F334F8C0CF995B45CB5ED340C8F2BDC22E352895D1B19C3E7D93722C07A8A` |
    | DIME-64bit.msi | `D366BD73B17C9FCDB15B2F809D1C6EAA1C8098EC141FE4035B6F34B14DDE57D5` |
    | DIME-32bit.msi | `7FCE199E3AB92D4829B8729394C67220B115E61860A3E43891C3F80425C6545A` |
   <!-- CHECKSUM_END -->
     </details>
