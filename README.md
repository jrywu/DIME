...
1. 下載安裝檔
   ...
   **最新穩定發行版本 DIME v.1.3.582（更新日期: 2026-04-01）**
   ...
   <!-- DOWNLOAD_START -->     
     <details>
     <summary><b>最新開發版本 DIME v1.3.588 (更新日期: 2026-04-01)</b></summary>
   <!-- DOWNLOAD_END -->
...
3. **（建議）驗證檔案完整性：**
   ...
   **最新穩定發行版本 DIME v.1.3.582 SHA-256 CHECKSUM (更新日期: 2026-04-01):**
   <!-- RELEASE_CHECKSUM_START -->    
    | 檔案 | SHA-256 CHECKSUM |
    |------|----------------|
    | DIME-Universal.exe | `A270A831049B355B9319B03982A6CD2D9B80E958FAA5033810C318650B238980` |
    | DIME-Universal.zip | `D45B57549E8BE8EF0CE028F890A5209E65B1B73F531E5FD756FD0344B2789CA4` |
    | DIME-64bit.msi | `10B501DAACB15A5B7E82F41AA2DF6558A212F12DEC1A2997C4192DAFD1329322` |
    | DIME-32bit.msi | `7541C0805F0AEB6496CD8DD3292689D25D30A27DAFD4BD5AEEB380537AD0D2B5` |
   <!-- RELEASE_CHECKSUM_END -->   

   <!-- CHECKSUM_START -->
     <details>     
     <summary><b>最新開發版本 DIME v1.3.588 SHA-256 CHECKSUM (更新日期: 2026-04-01)</b></summary>
   
    | 檔案 | SHA-256 CHECKSUM |
    |------|----------------|
    | DIME-Universal.exe | `B2426F792F4888A492D1DDA45F71005172DE4D95E63FD4E5C7CC1D187BA221C3` |
    | DIME-Universal.zip | `3F57C3D5AEB51113A418B937EA54508CDAB09287F4DF3648F277525090EEF27E` |
    | DIME-64bit.msi | `87B7828BBECA1E32E3BFDBBEA363FDC06AC2FDA59A24695556AF5E4FA80DF35E` |
    | DIME-32bit.msi | `79A15AD47CB6B1BCF4389C49F70D5AC3CEA2D2CEE1BF2BF8BE2EDDE4FDEA56FF` |
   <!-- CHECKSUM_END -->
     </details>
