...
<!-- CHECKSUM_START -->
   ...
   **最新版本 SHA-256 CHECKSUM (更新日期: 2026-02-10):**
   ...
   | 檔案 | SHA-256 CHECKSUM |
   |------|----------------|
   | DIME-x86armUniversal.exe | `97524284209622FA86A02272885BB072C3253905D55C0A2F65FA97C87203766B` |
   | DIME-x86armUniversal.zip | `C8CDEC112A4E808F16327163D5D33047E737B04179CF94D092DBF2DC11517AEF` |
...
| 在桌面模式顯示浮動中英切換視窗 | 切換中英文時在桌面右下角顯示提示視窗 |
| 回復原始設定 | 將外觀設定還原為預設值 |
...
| 提示聯想字詞 | 選字後顯示相關聯想詞 |
| 自建詞優先 | 自建詞庫的字詞優先於主碼表顯示 |
| 以方向鍵換頁 | 使用左右方向鍵切換候選字頁面 |
| 以空白鍵換頁 | 使用空白鍵切換至下一頁候選字 |
| 全半形輸入模式 | 設定預設的全形/半形模式（以 Shift+Space 切換、全形、半形） |
| 中英切換熱鍵 | 設定切換中英文的按鍵（左右 Shift、右 Shift、左 Shift、僅 Ctrl+Space） |
| 預設輸入模式 | 啟動時預設為中文或英數模式 |
| 輸出字元 | 輸出繁體中文或簡體中文 |
...
<img src="docs/ARRAY_CUSTOMSettings.png" alt="行列額外碼表設定按鈕" width="50%" />
