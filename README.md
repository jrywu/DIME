...
1. 下載通用安裝檔
   ...
   **最新穩定發行版本 DIME v.1.2.441（更新日期: 2026-02-21）**
   ...
   <!-- DOWNLOAD_START -->
   **最新開發版本 DIME v1.3.483 (更新日期: 2026-03-09)**
   <!-- DOWNLOAD_END --> 
...
3. **（建議）驗證檔案完整性：**
   ...
   **最新穩定發行版本 DIME v.1.2.441 SHA-256 CHECKSUM (更新日期: 2026-02-21):**
   ...
   <!-- CHECKSUM_START -->
   **最新開發版本 DIME v1.3.483 SHA-256 CHECKSUM (更新日期: 2026-03-09):**

   | 檔案 | SHA-256 CHECKSUM |
   |------|----------------|
   | DIME-Universal.exe | `CDDF6F9713A5BF3C6419611DEA9524F12F3D485E6D4403885E0207738B3F4BB3` |
   | DIME-Universal.zip | `04C20BC89814927A2B03126B488E4C1446F2A6371C0FFD482ACC9711324A4428` |
   | DIME-64bit.msi | `642BE81A5DD6B8F412332B07F48AE994FF5210600766D5E938DAB86359350DFE` |
   | DIME-32bit.msi | `34C6C9603B910C2326AF5C5D0B27A7FC9A85B96F08CA9918F8C62C178FF89336` |
   <!-- CHECKSUM_END -->
...
> **萬用字元與 Shift 英數的互動**：在大易、行列等輸入法中，Shift+8（`*`）與 Shift+/（`?`）同時也是萬用字元按鍵。若作為 Shift 英數連續輸入的第一個按鍵，會進入輸入法引擎啟動萬用字元搜尋；若已在連續輸入過程中，則依 CapsLock 狀態正常輸出字元（CapsLock OFF 輸出 `8` 和 `/`；CapsLock ON 輸出 `*` 和 `?`），不會觸發萬用字元功能。注音輸入法不支援 `*` 萬用字元，因此 Shift+8 在注音模式下一律作為 Shift 英數輸出。
