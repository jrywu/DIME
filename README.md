...
1. 下載通用安裝檔
   ...
   **最新穩定發行版本 DIME v.1.2.378**（更新日期: 2026-02-13）

   [DIME-Universal.zip](https://github.com/jrywu/DIME/raw/1.2.378/installer/DIME-Universal.zip)
...
3. **（建議）驗證檔案完整性：**
   ...
   **最新穩定發行版本 DIME v.1.2.378 SHA-256 CHECKSUM (更新日期: 2026-02-13):**
   
   | 檔案 | SHA-256 CHECKSUM |
   |------|----------------|
   | DIME-Universal.exe | `640B2DF9DFD5C6E749CBFEDFEF5BE424EEA53FF96F291AB5D865C2D439EACF98` |
   | DIME-Universal.zip | `672D255F8C32AF2CDB5BE99E33278AC43F409DB760CA653A1868D45CF5F4085E` |
   
   <!-- CHECKSUM_START -->
   **最新開發中版本 SHA-256 CHECKSUM (更新日期: 2026-02-15):**
   
   | 檔案 | SHA-256 CHECKSUM |
   |------|----------------|
   | DIME-Universal.exe | `D927FF9BBA79CAA97412994D9F2249C10255BDC34B881321F8972C336F3C6E83` |
   | DIME-Universal.zip | `B9CF1C1A3B5B0BB743E7520685CCE14A78E5C513476DE97D8DFCEE8748EC2CE4` |
   <!-- CHECKSUM_END -->
