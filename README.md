...
1. 下載安裝檔
   ...
   **最新穩定發行版本 DIME v.1.3.532（更新日期: 2026-03-18）**
   ...
   <!-- DOWNLOAD_START -->     
     <details>
     <summary><b>最新開發版本 DIME v1.3.537 (更新日期: 2026-03-19)</b></summary>
   <!-- DOWNLOAD_END -->
...
3. **（建議）驗證檔案完整性：**
   ...
   **最新穩定發行版本 DIME v.1.3.532 SHA-256 CHECKSUM (更新日期: 2026-03-18):**
   ...
   <!-- CHECKSUM_START -->
     <details>     
     <summary><b>最新開發版本 DIME v1.3.537 SHA-256 CHECKSUM (更新日期: 2026-03-19)</b></summary>
   
    | 檔案 | SHA-256 CHECKSUM |
    |------|----------------|
    | DIME-Universal.exe | `ED4184BC309AE2894206249C25B938AD5FBEE2C20F71C91384888B99FB89B160` |
    | DIME-Universal.zip | `713707D500D271B7B8BFA46E59C1EAA648E8D7B2B5CAB6443E70257F28EF5D66` |
    | DIME-64bit.msi | `9915A66E1AF49EF5F305C4D3718E9B4FE537128C11E8F84F941C830FED0D7D3E` |
    | DIME-32bit.msi | `6EEAC9CE8EABED19B36EEB3CBB2B513529C44BC658FC93D4422FE862E737F415` |
   <!-- CHECKSUM_END -->
     </details>
...
| Shift + Space | 切換全形/半形 |
| Ctrl + \\ | 開啟輸入法設定頁面 |
| Ctrl + Shift + H | 切換繁體/簡體中文輸出（僅中文模式下有效） |
