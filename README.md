...
1. 下載安裝檔
   ...
   **最新穩定發行版本 DIME v.1.3.588（更新日期: 2026-04-01）**
   ...
   <!-- DOWNLOAD_START -->     
     <details>
     <summary><b>最新開發版本 DIME v1.3.591 (更新日期: 2026-04-06)</b></summary>
   <!-- DOWNLOAD_END -->
...
3. **（建議）驗證檔案完整性：**
   ...
   **最新穩定發行版本 DIME v.1.3.588 SHA-256 CHECKSUM (更新日期: 2026-04-01):**
   ...
   <!-- CHECKSUM_START -->
     <details>     
     <summary><b>最新開發版本 DIME v1.3.591 SHA-256 CHECKSUM (更新日期: 2026-04-06)</b></summary>
   
    | 檔案 | SHA-256 CHECKSUM |
    |------|----------------|
    | DIME-Universal.exe | `AAA91F78F7AC1760551656A995B48ACD28BE12589C61158B019FAA22CEF69FD5` |
    | DIME-Universal.zip | `833649E5422C2681A11E655D1247EC24784B061810F18CBE900C12AEF425A1B1` |
    | DIME-64bit.msi | `A00CFD5D7E7B1A37FC56C64A8C34DD16DE31A2F35C09393D488CF861934A5D52` |
    | DIME-32bit.msi | `FAAB4D436D7910477D63790CEAE1CBF00D7FF5FF678D8B7A2E5C3645339D51A3` |
   <!-- CHECKSUM_END -->
     </details>
