...
<!-- CHECKSUM_START -->
   ...
   **最新版本 SHA-256 CHECKSUM (更新日期: 2026-02-10):**
   ...
   | 檔案 | SHA-256 CHECKSUM |
   |------|----------------|
   | DIME-x86armUniversal.exe | `FF24B46A22FCFC57F8B462A4BACDE3F48A8EE775A1A6714BB6D262D04929F0B4` |
   | DIME-x86armUniversal.zip | `ADABB2F3C49E7E9651CDE8911DD5582F1E6B4C667B98240CC167AD47EF188660` |
...
| 在桌面模式顯示浮動中英切換視窗 | 跟隨系統游標顯示浮動`中文`/`英文`切換提示視窗 |
| 回復原始設定 | 將外觀設定還原為預設值 |
