...
1. 下載通用安裝檔
   ...
   **最新穩定發行版本 DIME v.1.2.441（更新日期: 2026-02-21）**
   ...
   <!-- DOWNLOAD_START -->
   **最新開發版本 DIME v1.2.461 (更新日期: 2026-02-24)**
   <!-- DOWNLOAD_END --> 
...
3. **（建議）驗證檔案完整性：**
   ...
   **最新穩定發行版本 DIME v.1.2.441 SHA-256 CHECKSUM (更新日期: 2026-02-21):**
   ...
   <!-- CHECKSUM_START -->
   **最新開發版本 DIME v1.2.461 SHA-256 CHECKSUM (更新日期: 2026-02-24):**
   
   | 檔案 | SHA-256 CHECKSUM |
   |------|----------------|
   | DIME-Universal.exe | `FD0A26C25D0CB78A05961A8FEB8575039EBB649DFADF788BD2A3D35DD7E83DAC` |
   | DIME-Universal.zip | `D7F18D74010D872487630967E05537AACDECD3D725E30564BFDA4F03185093B3` |
   <!-- CHECKSUM_END -->
